                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="width: 570px; margin: 0 auto; padding: 0; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF;">
                  <tr>
                      <td style="padding: 35px;">
                        <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;">Resultado de calificación.</h1>

                        <p style="margin-top: 0;
                                  color: #74787E;
                                  line-height: 1.5em;
                                  font-size: 12px;
                                  text-align: left;">El cliente del hotel <strong><?php echo $hotel; ?></strong> ha contestado satisfactoriamente su encuesta.</p>

                        <p style="margin-top: 0;
                                  color: #74787E;
                                  line-height: 1.5em;
                                  font-size: 12px;
                                  text-align: left;">Con una calificación de: <strong><?php echo $calificacion; ?></strong></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;">Perteneciente a la fecha de <strong><?php echo $month; ?> <?php echo $year; ?></strong></p>
