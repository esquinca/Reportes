                  ...
                  <tr>
                      <td style="padding: 35px;">
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  line-height: 1.5em;
                                  font-size: 12px;
                                  text-align: left;">Estimado <strong>Administrador.</strong></p>

                        <p style="margin-top: 0;
                                  color: #74787E;
                                  line-height: 1.5em;
                                  font-size: 12px;
                                  text-align: left;">El encargado <strong><?php echo $nombre; ?>.</strong> con</p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;">Cuenta con el siguiente problema: <br><strong><?php echo $mensaje; ?> <?php echo date('l jS \de F Y h:i:s A'); ?></strong></p>
