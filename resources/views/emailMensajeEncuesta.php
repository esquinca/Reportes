                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="width: 570px; margin: 0 auto; padding: 0; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF;">
                  <tr>
                      <td style="padding: 35px;">
                        <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;">Información para el acceso al apartado de encuesta</h1>

                        <p style="margin-top: 0;
                                  color: #74787E;
                                  line-height: 1.5em;
                                  font-size: 12px;
                                  text-align: left;">Estimado <strong><?php echo $nombre; ?>.</strong></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  line-height: 1.5em;
                                  font-size: 12px;
                                  text-align: left;">Su usuario es: <strong><?php echo $correo; ?></strong></p>
                        ...
                        <a href=""  style="background-color: #3869D4;
                                  ...
                                  >Clic para acceder a la encuesta.</a>
