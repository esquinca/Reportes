...
@if (Auth::user()->Privilegio == 'Programador' || Auth::user()->Privilegio == 'IT' )
  @section('htmlheader_title')
      {{ trans('message.approval') }}
  @endsection
  @section('contentheader_title')
      {{ trans('message.approval') }} {{ trans('message.concierge') }}
  @endsection

  @push('scripts')
  <script src="/plugins/datepicker/bootstrap-datepicker.js"></script>
  <script src="/plugins/datepicker/locales/bootstrap-datepicker.es.js" charset="UTF-8"></script>
  <script src="/js/approval/concierge.js"></script>
  @endpush
          ...
          <table class="table table-striped table-bordered" id="table_type_reports" name="table_type_reports">
            <thead style="background-color: #001A36; color: white;">
              <tr >
                ...
                <th>{{ trans('message.approvaladmin') }}</th>
